...
Authors: David Fisher and Alexander Gavrilovich.
...
def main():
    ...
    my_name = "Alex"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "Will"  # Used to set the topic that you will *publish to*
